...
public class ApplyJobController {
	 ...
	 @PostMapping("/applicants/applyjob/{applicantId}/{jobId}")
	    public String saveJobForApplicant(
	        ...
	        try {
	        	applyJobService.ApplicantApplyJob(applicantId, jobId);
	            return "Job applied successfully for the applicant.";
	        } catch (Exception e) {
	            return "Unable to apply the job for the applicant.";
	        }
}
 ...
 public ResponseEntity<List<AppliedApplicantInfoDTO>> getAppliedApplicantsForRecruiter(@PathVariable long jobRecruiterId) {
   ...
   @GetMapping("/getScheduleInterviews/applicant/{applicantId}/{applyJobId}")
